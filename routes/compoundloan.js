...
router.post('/compoundLoanPayToPrincipal', function(req, res, next) {
	if (!req.body.duration | !req.body.principal | !req.body.interest | !req.body.payDown)
		return res.status(400).json({message: 'Please fill out all fields.'});

	var retObj = compoundLib.compoundLoan(req.body.duration, req.body.principal, req.body.interest, req.body.payDown);
